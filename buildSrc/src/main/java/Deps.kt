...
object Version {
    ...
    const val applicationId = "com.ff.iai.paxlauncher"
    const val minSdk = 28
...
fun buildOutputApkName(prefix: String, name: String): String {
    // PaxLauncher_hpc-debug_1.2.0.37_23031610.apk
    val apkName = "${prefix}_${name}_${Version.versionName}_${Version.versionCode}.apk"
    println("VerInfo-buildOutputApkName :$apkName")
    return apkName
}

// 大版本以及大版本对应的commitCount
private const val baseVerName = "1.2"
private const val baseVerCode = 354
...
private fun getCommitCount(): Int {
    ...
    println("VerInfo-getCommitCount :$count >>> $i")
    return i
}
...
private fun buildVerInfo(): Pair<Int, String> {
    ...
    // 1678932836097 >> 23031610
    val curTime = System.currentTimeMillis()
    val simpleDateFormat = SimpleDateFormat("yyMMddHH", Locale.getDefault())
    val dateStr = simpleDateFormat.format(curTime)
    val code = dateStr.toInt()

    println("VerInfo-buildVerInfo :$name , $code")
